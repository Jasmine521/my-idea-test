...
public class SendMailWithInlineImage {
    public static void main(String[] args) throws Exception {
        final String smtp = "smtp.exmail.qq.com";
        final String username = "jiuboyan@nuaa.edu.cn";
        final String password = "KhUf9VhrcNtagwjP";
        final String from = username;
        final String to = "intz.mayumi@foxmail.com";
